...
export const LOAD_INITIAL_FEATURES =
  ACTION_TYPE_PREFIX + 'LOAD_INITIAL_FEATURES'

export function addFeature<S, A>(
  id: string,
  feature: Feature<S, A>
): FeatureAction {
  return {
...
export function replaceFeature<S, A>(
  id: string,
  feature: Feature<S, A>
): FeatureAction {
  return {
...
export function installFeature<S, A>(
  id: string,
  feature: Feature<S, A>
): FeatureAction {
  return {
